...
const Plugin = () => {
	...
	function render() {
		...
		//embedded base64 search-prototype icon Designed by Sketchdock - http://www.sketchdock.com/:
	...
	function doSearch() {
		//if there's been a change in the search-prototype term, perform a new search-prototype:
		if (searchboxDirty) {
